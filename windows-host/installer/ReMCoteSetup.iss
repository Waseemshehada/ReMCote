...
;   MicrosoftEdgeWebview2Setup.exe (downloaded in CI, next to this script)
...
Filename: "{tmp}\MicrosoftEdgeWebview2Setup.exe"; Parameters: "/silent /install"; StatusMsg: "Installing desktop viewer runtime..."; Flags: waituntilterminated
